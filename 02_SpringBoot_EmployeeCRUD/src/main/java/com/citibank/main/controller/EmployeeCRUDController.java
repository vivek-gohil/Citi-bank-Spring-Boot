...
public class EmployeeCRUDController {
	...
	@GetMapping("employee/testing/{employeeId}")
	public String testing(@PathVariable int employeeId, @RequestBody Employee employee) {
		System.out.println(employeeId);
		System.out.println(employee.getName());
		System.out.println(employee.getSalary());
		return employeeId + " " + employee.getName();
	}
